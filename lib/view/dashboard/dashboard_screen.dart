...
import 'package:fitnessapp/view/feeds/feeds_view.dart';
...
class _DashboardScreenState extends State<DashboardScreen> { 
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        child: _loading == true ? CircularProgressIndicator()  : IndexedStack(
        index: selectTab,
          ...
          child: Row(
            ...
            children: [
              ...
              TabButton(
                  ...
                  selectIcon: "assets/icons/feeds.png",
